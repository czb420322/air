<template>
  <div class="device-page">
    ...
    <template v-if="activeTopTab === 'management'">
      ...
      <el-drawer :show-close="false" :visible="showDeviceDetail" :direction="'rtl'" :size="'500px'"
        @close="closeDeviceDetail" custom-class="device-detail-drawer">
        <div v-if="selectedDevice">
          ...
          <div v-if="!editingName" class="detail-content">
            ...
            <template v-if="activeDetailTab === 'related' && activeMachineTab === 'odu'">
      ...
      <el-drawer :modal="false" :show-close="false" :visible="showBatchControl" :size="'500px'"
